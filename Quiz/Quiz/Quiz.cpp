// ProjektWikiQuiz.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
public:
	...
	string GameModeName= "Normal GameMode";
...
void PrintQuestionA()
{
	...
	catch (int) { std::cout << "Can't open File\n\n"; }
